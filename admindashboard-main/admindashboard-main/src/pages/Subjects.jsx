...
class Subjects extends Component {
    ...
    handlePaginationChange = (event, value) => {
        ...
        axios
        .get(`${baseUrl}api/Subjects?&index=${value-1}&size=${this.state.size}`, {
        ...
        .then((res) => {
            ...
            newData.map((dat, index) => {
                ...
                dat.theImage = (
                    <div className="tableImg" style={{ backgroundImage: `url(${baseUrl + dat.imagePath})` }}></div>
                );
    ...
    componentDidMount() {
        ...
        axios
            .get(`${baseUrl}api/Subjects?&index=${this.state.index}&size=${this.state.size}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((res) => {
                if (res.status == 200) {
    ...
    exportToExcel = () => {
        ...
        axios.get(`${baseUrl}api/Subjects/DownloadInfo`, {
